...
<span style="color:red">⚠ swap sould be disabled only for the following nodes : </span> **<span style="color:red">registry, master, node0, node1, node2, node3.</span>** <span style="color:red">See [setup]() for more informations.</span>
